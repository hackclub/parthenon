                ...
                <div className="border border-[#DBC491]/50 flex flex-col md:flex-row gap-6">
                  <div className="p-6 md:p-14 w-full">
                    ...
                    <div className="text-lg md:text-2xl mt-2 text-[#F8E5D6] font-normal">
                      ...
                      with other top high school builders from around the world
                      to brainstorm, code, and ship projects. You&apos;ll take
                      part in hands-on workshops, team activities, and a final
                      showcase where they present what they&apos;ve built.
                      Beyond coding, it&apos;s a chance to make lifelong
                      friends, grow confidence, and be inspired by leaders in
                      technology.
                    </div>
                ...
                <div className="border border-[#DBC491]/50 flex flex-col md:flex-row gap-6">
                  <div className="p-8 md:p-14 w-full">
                    ...
                    <div className="text-2xl mt-2 text-[#F8E5D6] font-normal">
                      ...
                      technology. Parthenon is where the work of the athena
                      award comes together in one unforgettable weekend.
                    </div>
                  </div>
                </div>
              </div>
              ...
              <section className="py-16 px-4 md:px-24 text-[#F4E3C1]  bg-[#3B5435]">
                ...
                <div className="bg-[#222] p-4 mt-6">
                  <div className="border border-[#DBC491]/50 p-4 text-sm md:text-lg">
                    <p>
                      To participate in Athena Award and Parthenon, you have to
                      check these boxes:
                    </p>
